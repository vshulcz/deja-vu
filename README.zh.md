...
<p align="center">
LongMemEval-S（470 题清理集）上 <b>85.3% hit@1</b> &middot; LoCoMo 上 <b>69.7%</b> &middot; 数 GB 历史上的查询在<b>毫秒</b>级<br>
...
**在 Codex 里解决，Claude 记得。** 三十四个编程智能体把每一次对话都写进本地文件，
...
以及写在散文里的口令——「the admin password is …」这种没有任何分隔符可依的写法。
