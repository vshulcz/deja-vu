...
// heatX is the left offset of a month label. The column pitch is the square
// plus its gap; a label positioned on the square alone drifts a day a week and
// is a fortnight out by the end of the year.
func heatX(col int) int { return col * heatPitch }
