...
<footer>{{.SessionCount}} sessions embedded: dates, harnesses, projects, message counts, and the opening line of each session, redacted and shortened. No other message text is in this file.{{if .Truncated}} The embedded list is capped at the 5,000 most recent sessions.{{end}}</footer></main><script>
