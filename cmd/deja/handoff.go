...
var handoffPasteOnly = map[string]bool{"openclaw": true, "hermes": true, "roo": true, "kilocode": true, "cherrystudio": true, "zed": true, "deepseek": true, "copilot-chat": true, "continue": true}
