...
<p align="center">
<b>На 58–80% меньше токенов</b> на задаче, которую эта машина уже решала &middot; <b>88.1% hit@1</b> на LongMemEval-S (очищенный набор из 470 вопросов) &middot; <b>70.5%</b> на LoCoMo &middot; поиск по гигабайтам истории за <b>миллисекунды</b><br>
<sub>По 11 прогонов на плечо: 53,558 токенов против 126,222 без всякой памяти; на более поздней сборке, снова по 11 прогонов: 24,068 против 119,461 &middot;
